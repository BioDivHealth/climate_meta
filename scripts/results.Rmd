...
# write.csv(as.data.frame(list_of_dfs[["Overall"]]),'outputs/tables/TableS2_ChiSquare.csv', row.names = F)
...
#write.csv(results_regtests, 'outputs/tables/TableS3_eggers_funnel_tests.csv', row.names = F)
```
