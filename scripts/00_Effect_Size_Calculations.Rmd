...
# Read in the data
zooALL <- read.csv(here::here('data','dataset_final.csv'), header = TRUE, stringsAsFactors = FALSE, fileEncoding = "latin1")
...
# Save the final plot
#ggsave(here('outputs','combined_plot_A4_70percent_signif.png'), final_plot, width = 5.5, height = 6.7, units = "in", dpi = 300, scale = 1.7)
```
