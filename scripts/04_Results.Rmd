...
Calculates chi-square tests looking into differences in proprortions of reported
increased and decreases in zoonotic risk across different groups.
...
First need to run the `02_climate_variables.R` script and get the `es_climvars_proportions.csv` dataframe. 
...
source(here::here('scripts', '01_AD_KS_tests.R'))
