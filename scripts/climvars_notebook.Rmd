...
cont_temp_1 $`biol1 < 1` = 0
names(cont_temp_1) = c("es_cat", "> 1ºC", "< 1ºC")

cont_temp_05 <- create_contingency_table(df_temp, "es_cat", "bio1_most_frequent_05")
cont_temp_05 $`biol1 < 0.5` = 0
names(cont_temp_05) = c("es_cat", "> 0.5ºC", "< 0.5ºC")
...
names(cont_precip_100) = c("es_cat", "< -100mm", "> +100mm")
...
names(cont_precip_25) = c("es_cat", "< -25mm", "> +25mm")
