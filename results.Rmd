...
ggsave(f2, file="outputs/Figure2_new.png", device="png", units="in", width=12, height=9, dpi=600, scale=0.92)
```
...
p3
p3_rm
#ggsave(p3, file="outputs/FigureS2_AB.png", device="png", units="in", width=9.3, height=4, dpi=1000, scale=1)
#ggsave(p3_rm, file="outputs/FigureS2_CD.png", device="png", units="in", width=9.3, height=4, dpi=1000, scale=1)
```
