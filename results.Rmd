...
pl1 = ggplot(pv1, aes(x = P_value_specific, y = after_stat(density))) + 
  geom_histogram(aes(y = after_stat(density)), colour = 1, fill = "skyblue4", binwidth = 0.005, boundary = 0, alpha = 0.7) +
...
pl2 = ggplot(pv2, aes(x = P_value_specific, y = after_stat(density))) + 
  geom_histogram(aes(y = after_stat(density)), colour = 1, fill = "skyblue4", binwidth = 0.04, boundary = 0, alpha = 0.7) +
  geom_density(fill = "pink", alpha = 0.4) +
  geom_vline(xintercept = 0.05, linetype = "dashed", color = "red") +
