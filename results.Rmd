...
write.csv(as.data.frame(list_of_dfs[["Overall"]]),'outputs/tables/chisq_results_overall.csv', row.names = F)
write.csv(as.data.frame(list_of_dfs[["Temperature"]]),'outputs/tables/chisq_results_temperature.csv', row.names = F)
write.csv(as.data.frame(list_of_dfs[["Humidity"]]),'outputs/tables/chisq_results_humidity.csv', row.names = F)
write.csv(as.data.frame(list_of_dfs[["Precipitation"]]),'outputs/tables/chisq_results_precipitation.csv', row.names = F)
