...
funnel_plot_4 <- create_funnel_plot(f4, "cyan4", "Humidity",
                                    subplot_tag="D", positions = c(0.01,1.05)) + xlab("Effect Size (Hedge's g)") + ylab("")
...
print(abc)
ggsave(abc, file="outputs/FigureS2.png", device="png", units="in", width=8.5, height=5, dpi=1000, scale=1)
```
